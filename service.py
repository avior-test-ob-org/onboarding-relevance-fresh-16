...
SERVICE_NAME = "onboarding-relevance-fresh-16"
PEERS: tuple[Peer, ...] = (
    Peer("avior-test-ob-org/onboarding-relevance-fresh-17", "FRESH_17_URL"),
    Peer("avior-test-ob-org/onboarding-relevance-fresh-18", "FRESH_18_URL"),
)
